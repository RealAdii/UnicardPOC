...
const APP_ID = "0xf8c9C2a108B607D40bAdCE6dE25157F06F4D5206"
const APP_SECRET = "0xefee0a7574c35fe1552a8937acd7add48a2c06605364e7a4718bd98366177135"
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-black">
        <div className="text-center">
          <img src="/download.jpeg" alt="Logo" className="mb-4 mx-auto" />
          <h2 className="text-slate-300 text-lg mb-4">Hi Unicards Team, please enter the password to continue</h2>
          <input
            type="password"
            value={password}
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-8 mt-8 gap-4 bg-black">
      <div className="z-10 w-full flex flex-col gap-4 items-center justify-center font-mono text-sm">
        <h2 className="text-slate-300 text-sm lg:text-4xl md:text-3xl sm:text-xl xs:text-xs text-nowrap">Unicards :: Reclaim</h2>
        <h4 className="text-slate-400 text-sm lg:text-xl md:text-lg sm:text-lg xs:text-xs">This demo uses the <span className="text-slate-300 underline"><a href='https://www.npmjs.com/package/@reclaimprotocol/js-sdk'> JS SDK </a></span> to generate a proof of your Swiggy Address Book</h4>
